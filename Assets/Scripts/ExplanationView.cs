...
public class ExplanationView : MonoBehaviour
{
    ...
    public async void Show(string explanation, Sprite image, bool wasCorrect, Action onContinue, ViewpointType viewpoint, int currentStepIndex)
    {
